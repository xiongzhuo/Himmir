...
public class UserFaclitiyAdapter extends AlxRefreshLoadMoreRecyclerView.AlxDragRecyclerViewAdapter<Space> {
    //设置事件回调接口
    ...
    public UserFaclitiyAdapter(Context context, List<Space> mDatas, int itemLayout, boolean pullEnable) {
