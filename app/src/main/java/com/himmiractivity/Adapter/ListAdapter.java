...
import com.himmiractivity.activity.AddedSharedActivity;
...
public class ListAdapter extends BaseAdapter {
    ...
    public ListAdapter(Context context, Set<SwipeListLayout> sets, List<ManagerShardBean.ManagerShardSum> list) {
