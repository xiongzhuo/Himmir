package com.himmiractivity.circular_progress_bar;
...
public class CircularProgressBar extends ProgressBar {
    ...
    public CircularProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int color = a.getColor(R.styleable.CircularProgressBar_cpb_color, res.getColor(R.color.mediumturquoise));
