...
import com.himmiractivity.mining.app.zxing.view.ViewfinderView;
...
public class MipcaActivityCaptureActivity extends Activity implements Callback {
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (resultString.equals("")) {
            Toast.makeText(MipcaActivityCaptureActivity.this, "Scan failed!", Toast.LENGTH_SHORT).show();
        } else {
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        if (handler == null) {
            handler = new CaptureActivityHandler(MipcaActivityCaptureActivity.this, decodeFormats,
                    characterSet);
        }
    }
