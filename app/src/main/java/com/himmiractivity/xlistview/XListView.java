...
public class XListView extends ListView implements OnScrollListener {
	...
	protected void initWithContext(Context context) {
		...
		mHeaderTimeViewTitle = (TextView) mHeaderView
				.findViewById(R.id.xlistview_header_time_title);
		mHeaderTimeViewTitle.setText(getResources().getString(
		...
		mHeaderView.getViewTreeObserver().addOnGlobalLayoutListener(
				new OnGlobalLayoutListener() {
					...
					public void onGlobalLayout() {
						...
						System.out.println("GetmHeadViewHeight = "
								+ mHeaderViewHeight);
	...
	public void setAdapter(ListAdapter adapter) {
		/* * 将上拉加载更多footer加入listview的底部 * 并且保证只加入一次 */
		if (mIsFooterReady == false) {
			mIsFooterReady = true;
			addFooterView(mFooterView);
			// listview原生方法 }
	...
	public void setDownGlideListener(
			IXListViewDownGlideListener downGlideListener) {
	...
	public void disablePullLoadSpace() {
		mEnablePullLoad = false;
		mFooterView.space();
		mFooterView.setOnClickListener(null);
	}
	...
	public void disablePullLoadNodata(){
		mEnablePullLoad = false;
		mFooterView.noData();
		mFooterView.setOnClickListener(null);
	}
